...
quotesDict = {
# Jesus
"Jesus": ["The first and greatest victory is to conquer yourself.",
...
#Buddah
    "Buddah": ["You yourself, as much as anybody in the entire universe, deserve your love and affection.",
...
# Die hard
	...
	"Sgt. Al Powell (Die Hard)": ["Welcome to the party, pal!"],
	"Tony (Die Hard)": ["Now I have a machine gun. Ho Ho Ho."],
	"Airport Cop (Die Hard 2)": ["You don't like me because I'm white trash?"],
...
# Predator
	...
	"Dillon (Predator)": ["You're hit, you're bleeding, man.","Maybe I Can Get Even.",],
	"Mac (Predator)": [
...
# Terminator
	"Terminator (The Terminator)": ["I'll be back."],
	"Sarah Connor (The Terminator)": ["There's a storm coming.", "You're terminated, f****r!"],
	"Kyle Reese (The Terminator)": ["Come with me if you want to live."],
	"John Connor (Terminator 2)": ["Hasta la vista, baby."],
	"Terminator (Terminator 2)": ["I need a vacation."],
